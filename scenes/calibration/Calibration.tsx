...
const _w = (n: number) => (n / 375) * Dimensions.get("window").width;
const _h = (n: number) => (n / 812) * Dimensions.get("window").height;

const middleFace: FaceData = { "middle": {x:0,y:0},
    "bottomMouthPosition": {"x": _w(191.72916668653488), "y": _h(501.15625312924385)},
    "bounds": {"origin": {"x": _w(54.70416218042374), "y": _h(281.23957923054695)},
    "size": {"height": 275.31875905394554, "width": 275.31875905394554}},
    "deltaEye": {"x": _w(92.19583636522293), "y": _h(2.96041676402092)},
    "deltaMouth": {"x": _w(76.12500250339508), "y": _h(2.1145834028720856)},
    "faceID": 34,
    "leftCheekPosition": {"x": _w(129.56041464209557), "y": _h(445.7541679739952)},
    "leftEarPosition": {"x": _w(98.68749696016312), "y": _h(411.4979168474674)},

    "leftEyePosition": {"x": _w(149.01458194851875), "y": _h(383)},
    "rightEyePosition": {"x": _w(239.21041831374168), "y": _h(383)},

    "leftMouthPosition": {"x": _w(151.97499871253967), "y": _h(485)},
    "rightMouthPosition": {"x": _w(228.10000121593475), "y": _h(485)},

    "midEye": {"x": _w(195.11250013113022), "y": _h(385.06562431156635)},
    "midMouth": {"x": _w(190.0374999642372), "y": _h(484.02812756597996)},
    "noseBasePosition": {"x": _w(194.6895834505558), "y": _h(431.79791751503944)},
    "rightCheekPosition": {"x": _w(256.8583354949951), "y": _h(449.56041809916496)},
    "rightEarPosition": {"x": _w(294.92083674669266), "y": _h(411.075000166893)},
